...
public class Game 
{
	...
	{
		System.out.println("You can hold " + (HoldingCapacity - CurrentLoad) + " more pounds.");
	...
	private void Pick() 
	{
		if(currentRoom.NumberOfItemsInRoom() > 0)
		{
			...
			{
				System.out.println("Cannot pick up this item, it will put you " + ((weight + CurrentLoad) - HoldingCapacity) + " lbs over your capacity");
			}
		}
		else
		{
